...
// See the series of events below and the corresponding state reported by dear ikura_ext_imgui:
//------------------------------------------------------------------------------------------------------------------------------------------------
...
{
    // Read ikura_ext_imgui.cpp "API BREAKING CHANGES" section for 1.78 if you hit this assert.
