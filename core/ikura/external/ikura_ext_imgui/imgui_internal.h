...
// [SECTION] ImGuiContext (main ikura_ext_imgui context)
...
// In 1.89.4, we moved the implementation of "courtesy maths operators" from imgui_internal.h in ikura_ext_imgui.h
...
#error Please '#define IMGUI_DEFINE_MATH_OPERATORS' _BEFORE_ including ikura_ext_imgui.h!
#endif
...
//-----------------------------------------------------------------------------
// [SECTION] Context pointer
// See implementation of this variable in ikura_ext_imgui.cpp for comments and details.
//-----------------------------------------------------------------------------
...
// This is going to be exposed in ikura_ext_imgui.h when stabilized enough.
enum ImGuiItemFlags_
{
    ...
    ImGuiItemFlags_Disabled                 = 1 << 2,  // false     // Disable interactions but doesn't affect visuals. See BeginDisabled()/EndDisabled(). See github.com/ocornut/ikura_ext_imgui/issues/211
...
// Windows data saved in ikura_ext_imgui.ini file
...
struct IMGUI_API ImGuiWindow
{
    ...
    short                   BeginOrderWithinContext;            // Begin() order within entire ikura_ext_imgui context. This is mostly used for debugging submission order related issues.
...
namespace ImGui
{
    ...
    IMGUI_API ImDrawList*   GetBackgroundDrawList(ImGuiViewport* viewport);                     // get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear ikura_ext_imgui contents.
    IMGUI_API ImDrawList*   GetForegroundDrawList(ImGuiViewport* viewport);                     // get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear ikura_ext_imgui contents.
...
//#endif
    ...
    // - Set Shortcut() and SetNextItemShortcut() in ikura_ext_imgui.h
