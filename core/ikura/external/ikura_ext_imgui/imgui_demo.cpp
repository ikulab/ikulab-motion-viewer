...
//   - Read 'Programmer guide' in ikura_ext_imgui.cpp for notes on how to setup Dear ImGui in your codebase.
// Read top of ikura_ext_imgui.cpp and ikura_ext_imgui.h for many details, documentation, comments, links.
...
//   by ikura_ext_imgui.h using the IMGUI_DEFINE_MATH_OPERATORS define. For your own sources file they are optional
...
// In other ikura_ext_imgui sources we can use nicer internal functions from imgui_internal.h (ImMin/ImMax) but not in the demo.
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::Text("dear ikura_ext_imgui says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("See comments in ikura_ext_imgui.cpp.");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Enable gamepad controls. Require backend to set io.BackendFlags |= ImGuiBackendFlags_HasGamepad.\n\nRead instructions in ikura_ext_imgui.cpp for details.");
            ImGui::CheckboxFlags("io.ConfigFlags: NavEnableSetMousePos", &io.ConfigFlags, ImGuiConfigFlags_NavEnableSetMousePos);
            ImGui::SameLine(); HelpMarker("Instruct navigation to move the mouse cursor. See comment for ImGuiConfigFlags_NavEnableSetMousePos.");
            ImGui::CheckboxFlags("io.ConfigFlags: NoMouse",              &io.ConfigFlags, ImGuiConfigFlags_NoMouse);
            ImGui::SameLine(); HelpMarker("Instruct dear ikura_ext_imgui to disable mouse inputs and interactions.");
            ...
            ImGui::SameLine(); HelpMarker("Instruct dear ikura_ext_imgui to disable keyboard inputs and interactions.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        if (ImGui::TreeNode("Filtered Text Input"))
        {
            struct TextFilters
            {
                ...
                {
                    if (data->EventChar < 256 && strchr("ikura_ext_imgui", (char)data->EventChar))
                        return 0;
                    return 1;
                }
            };
            ...
            static char buf7[32] = ""; ImGui::InputText("\"ikura_ext_imgui\"",   buf7, 32, ImGuiInputTextFlags_CallbackCharFilter, TextFilters::FilterImGuiLetters); // Use CharFilter callback to disable some characters.
            ImGui::TreePop();
        }
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            "As with every widget in dear ikura_ext_imgui, we never modify values unless there is a user interaction.\n"
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            ...
            // will close the popup. Note that the visibility state of popups is owned by ikura_ext_imgui, so the input value
...
struct MyItem
{
    ...
    // As we don't rely on std:: or other third-party library to compile dear ikura_ext_imgui, we only have reliable access to qsort(),
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // types and ImVec2/ImVec4. Dear ImGui defines overloaded operators but they are internal to ikura_ext_imgui.cpp and not
