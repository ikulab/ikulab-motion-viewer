// dear ikura_ext_imgui: Platform Backend for GLFW
...
// Prefer including the entire ikura_ext_imgui/ repository into your project (either as a copy or as a submodule), and only build the backends you need.
// Learn about Dear ImGui:
// - FAQ                  https://dearimgui.com/faq
// - Getting Started      https://dearimgui.com/getting-started
// - Documentation        https://dearimgui.com/docs (same as your local docs/ folder).
// - Introduction, links and more at the top of ikura_ext_imgui.cpp
...
//   (passing install_callbacks=false in ImGui_ImplGlfw_InitXXX functions), set the current dear ikura_ext_imgui context and then call our callbacks.
...
static void ImGui_ImplGlfw_UpdateMouseCursor()
{
    ...
    // (those braces are here to reduce diff with multi-viewports support in 'docking' branch)
    {
        ...
        {
            // Hide OS mouse cursor if ikura_ext_imgui is drawing it or if it wants no cursor
