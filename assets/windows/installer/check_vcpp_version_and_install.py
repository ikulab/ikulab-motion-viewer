...
if __name__ == "__main__":
    installed, installed_version = get_msvc_version()
    ...
    # get required version from msvc_version.txt
    required_version = None
    with open("msvc_version.txt", "r") as f:
        required_version = f.read().strip()

    print("required version:", required_version)
    if required_version is None:
        print("msvc_version.txt not found.")
        sys.exit(1)
